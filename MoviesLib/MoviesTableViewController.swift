...
class MoviesTableViewController: UITableViewController {
    ...
    // ele vai trazer a lista de filmes da base de dados
    ...
    func loadMovies(){
        let fechRequest: NSFetchRequest<Movie> = Movie.fetchRequest()
        let sortDescriptor = NSSortDescriptor(key: "title", ascending: true)
        
        fechRequest.sortDescriptors = [sortDescriptor]
        
        
        fetchedResultController = NSFetchedResultsController(fetchRequest: fechRequest, managedObjectContext: context, sectionNameKeyPath: nil, cacheName: nil)
    ...
    */
    ...
    // quando vc faz um swipe pra esquerda aparece o botao para deletar
...
extension MoviesTableViewController : NSFetchedResultsControllerDelegate {
    //sempre que houver qualquer mudança no fechedResultController
